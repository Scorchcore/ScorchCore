...
import { ArrowRight, Flame, HelpCircle, X } from "lucide-react";
...
function HomeFaqSection() {
  return (
    <section className="alchemy-copy relative overflow-hidden bg-deep-abyss px-4 py-20 text-white md:px-8">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(125,249,255,0.13),transparent_34%),radial-gradient(circle_at_15%_70%,rgba(240,106,18,0.14),transparent_28%),linear-gradient(180deg,#010203_0%,#020607_54%,#010203_100%)]" />
      <div className="relative z-1 mx-auto max-w-6xl">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          <p className="alchemy-eyebrow mb-3 text-xs">Protocol FAQ</p>
          <h2 className="alchemy-heading-strong text-balance text-3xl leading-tight md:text-5xl">
            ScorchCore Answers
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-pretty text-sm leading-7 text-cyan-50/66 md:text-base">
            Fast answers for Prospectors, builders, and search engines reading
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {HOME_FAQ.map((item) => (
            <article
              key={item.question}
              className="group relative overflow-hidden border border-cyan-100/12 bg-black/42 p-5 shadow-[0_18px_50px_rgba(0,0,0,0.34)] backdrop-blur-md transition-all hover:-translate-y-0.5 hover:border-ethereal-cyan/45"
            >
              ...
              <div className="relative flex gap-4">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center border border-cyan-100/14 bg-black/50 shadow-[0_0_22px_rgba(125,249,255,0.08)]">
                  <HelpCircle className="h-5 w-5 text-magma-gold" />
                </div>
                <div>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Link
            href="/tokenomics"
            className="inline-flex min-h-11 items-center gap-2 border border-ethereal-cyan/35 bg-cyan-300/12 px-5 py-3 text-xs font-semibold uppercase text-cyan-50 transition-all hover:border-ethereal-cyan hover:bg-cyan-300/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300/75 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
          >
            Tokenomics
