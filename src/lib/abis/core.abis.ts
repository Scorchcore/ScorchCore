/**
 * ABIs de contratos - Categoría: CORE
 * Auto-generado - No editar manualmente
 */

export const CORETOKEN_ABI = [
  {
    "inputs": [],
...
export const METADATAREGISTRY_ABI = [
  {
    "inputs": [
      {
        "internalType": "string",
...
export const MEMENTOVALIDATOR_ABI = [
  {
    "anonymous": false,
    "inputs": [
      {
  ...
  },
  {
    ...
    "name": "calculateFinalFailureRate",
    "outputs": [
      {
        "internalType": "uint16",
  ...
  },
  {
    ...
    "name": "getRiskReductionPercentage",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "percentage",
